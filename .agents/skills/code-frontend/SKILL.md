...
description: |
  ...
  Implementa la UI siguiendo la Estructura General del Proyecto (Web) y el diseño premium estilo LinkedIn (Layout de 3 columnas en Web, Tab Bar inferior en Móvil).
...
- **Dependencias en `_Imports.razor`:** `@using Radzen`, `@using Radzen.Blazor`, `@using {ProjectName}.Shared.UI.Componentes.Layout`, `@using Microsoft.AspNetCore.Components.Authorization`.
